...
import org.asura.csveditor.csv.CSVFileReader;
import org.asura.csveditor.csv.CSVFileWriter;
import org.asura.csveditor.export.ErrorExport;
import org.asura.csveditor.files.FileStorage;
import org.asura.csveditor.fx.about.AboutController;
import org.asura.csveditor.fx.list.ErrorSideBar;
import org.asura.csveditor.fx.list.GotoLineDialog;
import org.asura.csveditor.fx.preferences.PreferencesController;
import org.asura.csveditor.fx.table.ObservableMapValueFactory;
import org.asura.csveditor.fx.table.ValidationCellFactory;
...
import org.asura.csveditor.fx.util.JavaFxUtils;
import org.asura.csveditor.fx.util.LoadFileService;
import org.asura.csveditor.fx.util.SaveFileService;
import org.asura.csveditor.fx.validation.ValidationEditorController;
import org.asura.csveditor.preferences.*;
import org.asura.csveditor.validation.ValidationError;
import org.asura.csveditor.validation.ValidationFileReader;
import org.asura.csveditor.validation.ValidationFileWriter;
 ...
 */
@Component
public class CSVEditorController extends FXMLController {
    ...
    public void about(ActionEvent actionEvent) {
        ...
        alert.setHeaderText("CSVEditor.fx");
    ...
    private void saveFile(String filterText, String filter, FileStorage fileStorage) {
     ...
     */
    private void addColumn(final String header, final TableView tableView) {
